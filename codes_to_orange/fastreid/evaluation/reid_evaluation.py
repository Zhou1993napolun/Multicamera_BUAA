...
class ReidEvaluator(DatasetEvaluator): # evaluator
    ...
    def evaluate(self):
        ...
        # with open('orange_demo/baseline_new/pids.txt', 'a') as f:
        #     for item in pids:
        #         f.write(str(item) + '\n')

        # with open('orange_demo/baseline_new/camids.txt', 'a') as f:
        #     for item in camids:
        #         f.write(str(item) + '\n')
        ################################################
        # demo更改部分
        ################################################
        array_save_path = 'orange_demo/video/0134_c6_t0860to0945/dist.npy'
        np.save(array_save_path, dist)
        ################################################
