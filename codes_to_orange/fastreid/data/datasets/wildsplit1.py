...
class WildSplit1(ImageDataset):
    # dataset_dir = 'Wildtrack_splited/1'
    dataset_dir = 'Wildtrack_splited_rerank/1'
    dataset_url = None
    dataset_name = "wildsplit1"
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(WildSplit1, self).__init__(train, query, gallery, **kwargs)
