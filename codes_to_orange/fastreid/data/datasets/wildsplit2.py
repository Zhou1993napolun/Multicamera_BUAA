...
class WildSplit2(ImageDataset):
    # dataset_dir = 'Wildtrack_splited/2'
    dataset_dir = 'Wildtrack_splited_rerank/2'
    dataset_url = None
    dataset_name = "wildsplit2"
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(WildSplit2, self).__init__(train, query, gallery, **kwargs)
