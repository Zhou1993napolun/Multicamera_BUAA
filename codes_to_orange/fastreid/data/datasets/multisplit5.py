...
class Multisplit5(ImageDataset):
    """Market1501.
    ...
    """
    dataset_dir = 'Multisplit/5'
    dataset_url = None
    dataset_name = "multisplit5"
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        gallery = self.process_dir(self.gallery_dir, is_train=False, is_query=False)

        super(Multisplit5, self).__init__(train, query, gallery, **kwargs)
